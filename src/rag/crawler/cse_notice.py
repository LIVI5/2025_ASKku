    ...
    for page_num in range(max_pages):
        ...
        for item in items:
            ...
            if not link.startswith("http"):
                link = "https://cse.skku.edu/cse/notice.do" + link
        ...
        # 모든 글이 중복이고, 고정 공지만 있는 경우가 아니라면 계속 진행
        # (고정 공지를 제외한 일반 글이 모두 중복이면 다음 페이지로)
        
        # 수집한 링크들을 순회하며 본문 크롤링
